...
public class VentasController {
	 ...
	 * @return La ruta del enpoint con el id del objeto generado y guardado en la
	 *         base de datos
	 * @author Grupo 2 - Alonso
	 * @version 1.0 : 11/10/2022
	 */
	@Operation(summary = "Añadir una venta al sistema mediante un JSON en el body", description = "Dado un usuario y un evento se genera una venta", tags = {
			"Usuario", "Evento" })
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "La venta no se agregado correctamente", content = @Content) })

	@PostMapping("/add")
	public ResponseEntity<?> addVenta(@Valid @RequestBody Venta venta) {
